...
class MotionBuilderEngine(sgtk.platform.Engine):
    ...
    def post_app_init(self):
        ...
        MOTIONBUILDER_2019_VERSION=19000.0
        MOTIONBUILDER_2023_VERSION=23000.0
        ...
        if FBSystem().Version==MOTIONBUILDER_2019_VERSION:
            cmd='setx MOTIONBUILDER_PLUGIN_PATH "Z:\\dev\\tools\\plug-ins\\mobu\\UnityMeshSync_MotionBuilder\\MotionBuilder2019"'
            os.system(cmd)
        elif FBSystem().Version==MOTIONBUILDER_2019_VERSION:
            cmd='setx MOTIONBUILDER_PLUGIN_PATH ""'
            os.system(cmd)
