...
class HoudiniLauncher(SoftwareLauncher):
    ...
    EXECUTABLE_TEMPLATES = {
        ...
        "win32": [
            ...
            "C:/Program Files/Side Effects Software/Houdini {version}/bin/{executable}",
            # "C:/Program Files/Side Effects Software/Houdini 20.5.332/bin/houdinifx.exe"
        ],
        "linux2": [
    ...
    def scan_software(self):
        ...
        for sw_version in self._find_software():
            print('houdini version:', sw_version.version)
            (supported, reason) = self._is_supported(sw_version)
            print('houdini supported:', supported, reason)
            if supported:
